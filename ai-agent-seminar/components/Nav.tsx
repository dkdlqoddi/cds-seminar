...
const items = [
  { href: "/ai-agent", label: "1. 에이전트란" },
  { href: "/vs-chatbot", label: "2. 챗봇과의 차이" },
  { href: "/roo-code", label: "3. Roo Code" },
    ...
    <header className="sticky top-0 z-30 border-b border-zinc-200 bg-white/85 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        <Link href="/" className="text-sm font-bold tracking-tight text-zinc-900">
          AI 에이전트 입문 <span className="text-zinc-400">·</span>{" "}
          <span className="text-blue-600">Roo Code</span>
        </Link>
